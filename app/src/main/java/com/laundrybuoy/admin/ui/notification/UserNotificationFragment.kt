...
import com.laundrybuoy.admin.databinding.FragmentUserNotificationBinding
...
@AndroidEntryPoint
class UserNotificationFragment : BaseFragment() {
    ...
    private fun initObserver() {
        viewLifecycleOwner.lifecycleScope.launch {
            homeViewModel.getNotificationListing("user").observe(viewLifecycleOwner) {
